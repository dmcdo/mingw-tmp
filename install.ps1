Invoke-WebRequest -OutFile $env:TEMP\release-posix-seh.7z -URI "https://github.com/dmcdo/mingw-w64-install-script/raw/master/x86_64-8.1.0-release-posix-seh-rt_v6-rev0.7z"
Invoke-WebRequest -OutFile $env:TEMP\7zr.exe -URI "https://www.7-zip.org/a/7zr.exe"
cmd /c "`"$env:TEMP\7zr.exe`" x $env:TEMP\release-posix-seh.7z -o$env:USERPROFILE\release-posix-seh -y"
Remove-Item $env:TEMP\release-posix-seh.7z
